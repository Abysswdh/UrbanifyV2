...
const questions = [
  {
    ...
    options: [
      "Energi yang berasal dari bahan kimia berbahaya",
      "Energi yang berasal dari sumber daya alam yang terbarukan",
      "Energi yang hanya digunakan sekali",
      "Energi yang hanya dihasilkan oleh perusahaan besar",
    ],
    answer: "Energi yang berasal dari sumber daya alam yang terbarukan",
  },
  {
    question:
      "Sebutkan salah satu contoh kota di Indonesia yang sudah menerapkan sistem Smart Environment",
  ...
  },
  {
    ...
    options: [
      ...
      "Menambah polusi lingkungan",
      "Meningkatkan efisiensi dan pengawasan lingkungan",
      "Membatasi penggunaan energi terbaharukan",
    ],
    answer: "Meningkatkan efisiensi dan pengawasan lingkungan",
  },
  {
    question:
      "Bagaimana pengambilan data dalam penggunaan IoT dalam Smart Enviroment?",
    options: [
      "Melalui jaringan sosial",
      "Dengan menggunakan perangkat GPS",
      "Melalui sensor-sensor yang terhubung pada objek dan lingkungan",
      "Melalui pengecekan secara manual",
    ],
  ...
  },
  {
    ...
    options: [
      "Bangunan yang hanya berfokus pada estetika visual",
      "Bangunan yang menggunakan sumber daya alam secara berlebihan",
      "Bangunan yang dirancang untuk mengurangi dampak lingkungan dan menghemat sumber daya",
      "Bangunan yang tidak memperhatikan efisiensi energi dan pengelolaan limbah",
    ],
    answer:
      "Bangunan yang dirancang untuk mengurangi dampak lingkungan dan menghemat sumber daya",
  },
